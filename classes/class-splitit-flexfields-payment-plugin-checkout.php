...
class SplitIt_FlexFields_Payment_Plugin_Checkout {
	...
	public function get_billing_address( $order_info ) {
        return array(
            'first_name' => $order_info['billing_first_name'] ?? null,
            'last_name'  => $order_info['billing_last_name'] ?? null,
            'company'    => $order_info['billing_company'] ?? null,
            'email'      => $order_info['billing_email'] ?? null,
            'phone'      => $order_info['billing_phone'] ?? null,
            'address_1'  => $order_info['billing_address_1'] ?? null,
            'address_2'  => $order_info['billing_address_2'] ?? null,
            'city'       => $order_info['billing_city'] ?? null,
            'state'      => $order_info['billing_state'] ?? null,
            'country'    => $order_info['billing_country'] ?? null,
            'postcode'   => $order_info['billing_postcode'] ?? null,
        );
	}
	...
	public function get_shipping_address( $order_info ) {
        return array(
            'first_name' => $order_info['shipping_first_name'] ?? null,
            'last_name'  => $order_info['shipping_last_name'] ?? null,
            'company'    => $order_info['shipping_company'] ?? null,
            'email'      => $order_info['shipping_email'] ?? null,
            'phone'      => $order_info['shipping_phone'] ?? null,
            'address_1'  => $order_info['shipping_address_1'] ?? null,
            'address_2'  => $order_info['shipping_address_2'] ?? null,
            'city'       => $order_info['shipping_city'] ?? null,
            'state'      => $order_info['shipping_state'] ?? null,
            'country'    => $order_info['shipping_country'] ?? null,
            'postcode'   => $order_info['shipping_postcode'] ?? null,
        );
    }
}
